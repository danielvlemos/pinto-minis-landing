  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        accent: "bg-gradient-accent text-accent-foreground hover:shadow-glow hover:scale-105 transform transition-all duration-300 font-semibold",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-elegant",
        premium: "bg-gradient-primary text-primary-foreground hover:shadow-glow hover:scale-105 transform transition-all duration-300 font-bold border-2 border-primary-glow/30",
      },
      size: {
